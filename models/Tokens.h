...
class Tokens
{
  public:
    struct Cols
    {
        ...
        static const std::string _id_api;
        static const std::string _expiry;
    };
    ...
    /**  For column id_api  */
    ///Get the value of the column id_api, returns the default value if the column is null
    const int32_t &getValueOfIdApi() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<int32_t> &getIdApi() const noexcept;
    ///Set the value of the column id_api
    void setIdApi(const int32_t &pIdApi) noexcept;

    /**  For column expiry  */
    ///Get the value of the column expiry, returns the default value if the column is null
    const ::trantor::Date &getValueOfExpiry() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<::trantor::Date> &getExpiry() const noexcept;
    ///Set the value of the column expiry
    void setExpiry(const ::trantor::Date &pExpiry) noexcept;
  ...
  private:
    ...
    friend drogon::orm::BaseBuilder<Tokens, true, false>;
    friend drogon::orm::BaseBuilder<Tokens, false, true>;
    friend drogon::orm::BaseBuilder<Tokens, false, false>;
#ifdef __cpp_impl_coroutine
    ...
    std::shared_ptr<int32_t> idApi_;
    std::shared_ptr<::trantor::Date> expiry_;
    struct MetaData
    {
